...
&nbsp;Represents Required Fields</td>
        ...
        <tr>
            ...
            <td style="width: 447px">
                    <asp:TextBox ID="TextBoxSurname" runat="server" style="border-radius:5px" Height="30px" Width="250px"></asp:TextBox>
                    <span style="color: #FF0000">*</span></td>
            <td>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="TextBoxSurname" ErrorMessage="Surname Is required" ForeColor="Red"></asp:RequiredFieldValidator>
                </td>
        </tr>
        <tr>
            <td style="width: 259px" class="text-center">
            ...
            <td style="width: 447px">
                    <asp:TextBox ID="TextBoxfName" runat="server" style="border-radius:5px" Height="30px" Width="250px"></asp:TextBox>
                    <span style="color: #FF0000">*</span></td>
            <td>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="First Name required" ControlToValidate="TextBoxfName" ForeColor="Red"></asp:RequiredFieldValidator>
                </td>
        </tr>
        <tr>
            <td style="width: 259px" class="text-center">
            ...
            <td style="width: 447px">
                    <asp:TextBox ID="TextBoxNumber" runat="server" style="border-radius:5px" Height="30px" Width="250px" MaxLength="10"></asp:TextBox>
                    <span style="color: #FF0000">*</span></td>
            <td>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="Number is Required" ControlToValidate="TextBoxNumber" ForeColor="Red"></asp:RequiredFieldValidator>
                </td>
        </tr>
        <tr>
            <td style="width: 259px" class="text-center">
            ...
            <td style="width: 447px">
                    <asp:TextBox ID="TextBoxDate" runat="server" style="border-radius:5px" Height="30px" TextMode="Date" Width="250px" ></asp:TextBox>
                    <span style="color: #FF0000">*</span></td>
            <td>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="Date is required" ControlToValidate="TextBoxDate" ForeColor="Red"></asp:RequiredFieldValidator>
                </td>
        </tr>
        <tr>
            <td style="width: 259px" class="text-center">
            ...
            <td style="width: 447px">
                    <asp:TextBox ID="TextBoxAge" runat="server" style="border-radius:5px" Height="30px" Width="45px" TextMode="Number" ></asp:TextBox>
                    <span style="color: #FF0000">*</span></td>
            <td>
                    <span class="auto-style6">
                    <asp:RangeValidator ID="RangeValidator1" runat="server" ControlToValidate="TextBoxAge" Type ="Integer" MinimumValue="5" MaximumValue="120" CssClass="input-error" Display="Dynamic" ErrorMessage ="Enter Age above 5 Years and below 120 Years" ForeColor="Red"></asp:RangeValidator>
                    </span>
                </td>
        </tr>
        <hr />
        ...
        <tr>
            <td style="width: 259px">
                    <asp:CheckBoxList ID="CheckBoxListOptions" runat="server" Height="200px" style="margin-right: 0px" Width="245px">
        ...
        <tr>
            ...
            <td style="width: 447px">
                    ...
                    <asp:RadioButtonList ID="RadioButtonFOOD" runat="server" RepeatDirection="Horizontal" style="margin-right: 0px" Width="580px">
            ...
            <td>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidatoreato" runat="server" ControlToValidate="RadioButtonFOOD" ErrorMessage="Tick One" ForeColor="Red"></asp:RequiredFieldValidator>
                </td>
        </tr>
        <tr>
            ...
            <td style="width: 447px">
                    ...
                    <asp:RadioButtonList ID="RadioButtonFilms" runat="server" RepeatDirection="Horizontal" style="margin-right: 0px" Width="580px">
                        <asp:ListItem> Strongly Agree</asp:ListItem>
                        <asp:ListItem> Agree</asp:ListItem>
                        <asp:ListItem> Neutral</asp:ListItem>
                        <asp:ListItem> Disagree</asp:ListItem>
            ...
            <td>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidatormovie" runat="server" ControlToValidate="RadioButtonFilms" ErrorMessage="Tick One" ForeColor="Red"></asp:RequiredFieldValidator>
                </td>
        </tr>
        <tr>
            ...
            <td style="width: 447px">
                    ...
                    <asp:RadioButtonList ID="RadioButtonTelevision" runat="server" RepeatDirection="Horizontal" style="margin-right: 0px" Width="580px">
                        <asp:ListItem> Strongly Agree</asp:ListItem>
                        <asp:ListItem> Agree</asp:ListItem>
                        <asp:ListItem> Neutral</asp:ListItem>
                        <asp:ListItem> Disagree</asp:ListItem>
            ...
            <td>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidatortv" runat="server" ControlToValidate="RadioButtonTelevision" ErrorMessage="Tick One" ForeColor="Red"></asp:RequiredFieldValidator>
                </td>
        </tr>
        <tr>
        ...
        <tr>
            <td style="width: 259px">
                    <asp:Button ID="Btnsubmit" runat="server" style="border-color:aqua" Text="Submit" Height="45px" Width="150px" OnClick="Btnsubmit_Click" />
                </td>
            <td style="width: 447px">
                    &nbsp;</td>
            <td>&nbsp;</td>
